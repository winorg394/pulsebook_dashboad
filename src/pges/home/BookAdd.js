    ...
    <div className="modal-dialog" role="document">
        <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <div className="mb-3">
                        <input className="form-control" type="text" placeholder="Auteur du livre"  {...register("author", { required: true })} /></div>
                    {errors.title && <span style={{ color: "red" }}>This field is required</span>}

                <div className="mb-3">
                        <input className="form-control" type="text" placeholder="Titre du livre"  {...register("title", { required: true })} /></div>
                    {errors.title && <span style={{ color: "red" }}>This field is required</span>}
                    <div className="mb-3">
                    ...
                    {errors.publishingHouse && <span style={{ color: "red" }}>This field is required</span>}
                    
                    <div className="mb-3">
                        <input className="form-control" type="text" placeholder="nombre de page"  {...register("numberOfPage", { required: true })} /></div>
                    {errors.numberOfPage && <span style={{ color: "red" }}>This field is required</span>}
                    <div className="mb-3">
                        <input className="form-control" type="text" placeholder="releaseDate"  {...register("releaseDate", { required: true })} /></div>
                    {errors.releaseDate && <span style={{ color: "red" }}>This field is required</span>}
                    <div className="mb-3">
                    ...
                    {errors.picture && <span style={{ color: "red" }}>picture is required</span>}
                    <div className="mb-3">
                        <input className="form-control" type="file"  {...register("pdf")} placeholder="pdf du livre" /></div>
                    {errors.pdf && <span style={{ color: "red" }}>picture is required</span>}
                    <div className="mb-3">
